...
{
    class Att : INASRDataParser
    {
        public string SiteNumber { get; private set; }
        public int SequenceNumber { get; private set; }
        public static bool TryParse(string recordString, out Att att)
        {
            return NASRDataParserGeneric<Att>.TryParse(recordString, 1529, "ATT", fieldList, out att);
        }
